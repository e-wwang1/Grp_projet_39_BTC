...
Cependant, ce code présente des limitations : certaines fonctionnalitées demandées dans les consignes ne sont pas encore implémentées ou du moins elles sont mais partiellement:
• le programme n'inclut pas encore de gestion avancée des erreurs (par exemple pour les valeurs incorrectes)
